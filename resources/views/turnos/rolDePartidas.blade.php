          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Rol de Partida de los Buses</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <button type="submit" class="btn btn-success"> <a href="marcarEntrada"> Redireccion Pendiente </a> </button>
                        ...
                        <tbody> <!-- datos de la tabla -->                            
                          @foreach($listaTurnos as $turno)
                            <tr class="even pointer">
                              ...
                              <td > {{ $c++ }} </td>
                              <td >{{ $turno->fecha }}</td>
                              <td >{{ $turno->id_interno }}</td>

                              @foreach($Personas as $Persona)
                                @if (  $Persona->id == $turno->id_chofer )
