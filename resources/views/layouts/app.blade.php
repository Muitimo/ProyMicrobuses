                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                      <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                          ...
                          <li><a><i class="fa fa-bus"></i> Busese <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                              <li><a href="reg_Bus">Registrar Bus</a></li>
                              <li><a href="listaBuses">Buses Registrados</a></li>
                              <li><a href="listaAsignacines">Bus - Chofer</a></li>
                            </ul>
                          </li>

                          <li><a><i class="fa fa-edit"></i> Asistencia Laboral <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                              <li><a href="marcarEntrada">Marcar Entrada</a></li>
                              <li><a href="marcarSalida">Marcar Salida</a></li>
                              <li><a href="reporteAsistencias">Reporte Asistencias</a></li>
                            </ul>
                          </li>

                          <li><a><i class="fa fa-table"></i> Turnos <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                              <li><a href="rolDePartidas">Rol de partidas </a></li>
                              <li><a href="tables_dynamic.html">Horario de salida</a></li>
                            </ul>
                          </li>

                          <li><a><i class="fa fa-bullseye"></i> Puntos de Control <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                              <li><a href="reg_PuntoDeControl">Nuevo punto de Control</a></li>
