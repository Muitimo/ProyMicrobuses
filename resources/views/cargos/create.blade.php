          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Formulario de Registro de nueva Cargo</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate  method="POST" action="guardarCargo" >
                      @csrf
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Ingrese una breve descripcion </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
