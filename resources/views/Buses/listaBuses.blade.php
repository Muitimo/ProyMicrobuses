          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Lista de Buses Registrados</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <button type="submit" class="btn btn-success"> <a href="reg_Bus"> Registrar nuevo Microbus </a> </button>
                        ...
                        <tbody> <!-- datos de la tabla -->                          
                          @foreach($Microbuses as $Microbus)
                            <tr class="even pointer">
                              ...
                              <td >{{ $Microbus->interno }}</td>
                              <td >{{ $Microbus->placa }}</td>
                              <td >{{ $Microbus->marca }}</td>
                              <td >{{ $Microbus->modelo }}</td>
                              <td >{{ $Microbus->nropasajeros }}</td>
                              @foreach($Personas as $Persona)
                                @if (  $Persona->id == $Microbus->id_propietario )
